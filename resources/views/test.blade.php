                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('minimilitia') }}">
                        ...
                        <div dir="ltr">
                            ...
                            <div class="form-group{{ $errors->has('erfan') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                    <input id="erfan" type="number" class="form-control text-center" name="erfan"
                                           value="{{ old('erfan') }}"
                            ...
                            <div class="form-group{{ $errors->has('hossein') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                    <input id="hossein" type="number" class="form-control text-center" name="hossein"
                                           value="{{ old('hossein') }}"
                            ...
                            <div class="form-group{{ $errors->has('reza') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                    <input id="reza" type="number" class="form-control text-center" name="reza"
                                           value="{{ old('reza') }}"
                            ...
                            <div class="form-group{{ $errors->has('alireza') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                    <input id="alireza" type="number" class="form-control text-center" name="alireza"
                                           value="{{ old('alireza') }}"
